...
$link= $data->link;
 ...
 <div style='width:100%;padding:3%;padding-bottom: 1%;'>
   <p style='text-align:left;width:80%;'>
     ...
     '>
       <a  style='background-color: #1871CA;border: none;color: white; padding: 12px 16px;font-size: 16px;cursor: pointer;box-sizing: border-box;border-radius: 30px;text-transform: capitalize;text-decoration:none;' href=$link>Confirm my account</a>
     </div>
