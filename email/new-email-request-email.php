...
$link= $data->link;
 ...
 <div style='width:100%;padding:3%;padding-bottom: 1%;'>
   <p style='text-align:left;width:80%;'>
     ...
     Hello $name <br>
     <br>
     We have received a new email request for this email address, please click the link below if this was you:
     <div style='width:100%; text-align: left;padding:1%;margin: 2rem 0;
     '>
       <a  style=' text-decoration: none; background-color: #1871CA;border: none;color: white; padding: 12px 16px;font-size: 16px;cursor: pointer;box-sizing: border-box;border-radius: 30px;text-transform: capitalize;' href=$link>I agree</a>
     </div>
